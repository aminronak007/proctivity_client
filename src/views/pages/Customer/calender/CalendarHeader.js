    ...
    <div className="calender-toolbar-container">
      <div className="filter-container">
        <div className="flex-1 fs-20 bold-text title">
          <span className="hash fs-20 bold-text"># </span> Big Calendar
        </div>
        <RoyTooltip id={`today`} title={"Today"} placement="bottom">
          <button id={`today`} className="btn btn-back" onClick={goToCurrent}>
            <i className="material-icons taskboardicons--text">today</i>
          </button>
        </RoyTooltip>
        <RoyTooltip id={`month`} title={"Month"} placement="bottom">
          ...
          >
            <i className="material-icons taskboardicons--text">view_module</i>
          </button>
        </RoyTooltip>
        <RoyTooltip id={`week`} title={"Week"} placement="bottom">
          ...
          >
            <i className="material-icons taskboardicons--text">view_week</i>
          </button>
        </RoyTooltip>
        <RoyTooltip id={`workweek`} title={"Work Week"} placement="bottom">
          ...
          >
            <i className="material-icons taskboardicons--text">view_array</i>
          </button>
        </RoyTooltip>
        <RoyTooltip id={`day`} title={"Day"} placement="bottom">
          ...
          >
            <i className="material-icons taskboardicons--text">view_day</i>
          </button>
        </RoyTooltip>
        <RoyTooltip id={`agenda`} title={"Agenda"} placement="bottom">
          ...
          >
            <i className="material-icons taskboardicons--text">view_agenda</i>
          </button>
        </RoyTooltip>
      </div>
