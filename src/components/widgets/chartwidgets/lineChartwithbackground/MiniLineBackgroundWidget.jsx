...
const MiniLineBackgroundWidget = props => {
  ...
  return (
    <MiniLineBackChartWrapper dark={dark} background={background}>
      <div className={classNames("roe-shadow-2 miniline-container", className)}>
        <div className="pa-24 backImage">
          <div className="flex-x align-center">
            <div className="fs-26 demi-bold-text widget-count">{count}</div>
            <div className="fs-16 bold-text widget-light-grey-color pt-4 pl-3">
              {headline}
            </div>
          </div>
