...
const UserList = props => {
  ...
  return (
    <UserListWrapper {...props}>
      <Scrollbars autoHide className="user-list-height border-bottom-radius">
              ...
              return (
                <div
                  className={classNames(
                    "user-list-block",
                    activeUserDetail.id === user.id && "active-profile"
                  )}
                  key={i}
