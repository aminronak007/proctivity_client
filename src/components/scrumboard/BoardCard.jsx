        ...
        >
          <div {...provided.dragHandleProps}>
            <div className="column-title">
              <div title={card.title} className="title fs-16 bold-text">
                {card.title}
              </div>
              <div className="more_icon">
                <i className="fas fa-ellipsis-h" id={"card-" + card.id}></i>
                <Popover
                  trigger="legacy"
                  className="roy-menu"
                ...
                >
                  <PopoverBody>
                    <div
                      ...
                      onClick={() => deleteAllTaksFromCardHandler(card.id)}
                    >
                      Delete All Task
                    </div>
                    <div
          ...
          {!addCardFlag ? (
            ...
            <div className="add-card-input-block">
              ...
              <div className="action">
                <button className="c-btn c-success mr-10" onClick={addNewTask}>
                  Add Card
                </button>
                <button
