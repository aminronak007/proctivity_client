...
const CardTask = props => {
  ...
  if (task.subtasks && task.subtasks.length) {
    ...
    completedSubtask = task.subtasks.filter(a => a.completed === true).length;
  }
            ...
            >
              ...
              >
                    ...
                    task.labels.map((e, i) => {
                      return (
                        <div
                          key={i}
                          title={e.name}
                          className={classNames("task-status", e.color)}
                        ></div>
                      );
                    })}
                </div>
                ...
                <div className="task-options">
                  ...
                  <div className="count-space">{allComments.length}</div>
                  <div className="icon-space">
                    <i title="Attachments" className="fas fa-paperclip"></i>
                  </div>
                  <div className="count-space">{task.attachments.length}</div>
                  <div className="icon-space">
                    <i
                      title="sub-tasks"
                      className={classNames(
                        ...
                        task.subtasks.length &&
                          completedSubtask === task.subtasks.length &&
                          "success--text"
                      )}
                    ></i>
                  </div>
