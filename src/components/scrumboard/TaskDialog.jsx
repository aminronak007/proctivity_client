...
const CardTask = props => {
  ...
  if (hideCompletedSubtask) {
    subtaskList = taskDetail.subtasks.filter(
      a =>
        !a.completed && a.title.toLowerCase().includes(searchText.toLowerCase())
    );
  } else {
              ...
              <div>
                {taskDescriptionOpen && (
                  <div>
                    {!descriptionEdit ? (
                      <div
                        className="task-description mb-10"
                ...
                <div className="dialog-flex">
                  <div className="left-side">
                    <div className="sub-task">
                        ...
                        <div>
                          ...
                          >
                            <i
                              ...
                              onClick={() =>
                                setHideCompletedSubtask(!hideCompletedSubtask)
                              }
                            ></i>
                          </RoyTooltip>
                        </div>
                      ...
                      <div className="subtask-list">
                        {taskDetail && subtaskList && subtaskList.length ? (
                            ...
                            return (
                              <Subtask
                                ...
                                deleteSubtaskHandler={subtaskId =>
                                  deleteSubtaskHandler(subtaskId, taskDetail.id)
                                }
                                ...
                                addCommentHandler={(commentObj, subtaskId) =>
                                  addCommentHandler(
                                    commentObj,
                                    subtaskId,
                                    taskDetail.id
                          ...
                          <div className="no-subtask-info">
                            ...
                            <div>There are No subtasks attached</div>
                          </div>
                        )}
                        <div>
                          {!addSubtaskFlag ? (
                            <div
                              ...
                              onClick={() => setAddSubtaskFlag(true)}
                            >
                            ...
                            <div className="add-comment-input-block">
                              ...
                              <div className="subtask-action">
                                ...
                                <button
                                  ...
                                  onClick={() => setAddSubtaskFlag(false)}
                                >
                                  Cancel
                                </button>
                              </div>
                  ...
                  <div className="right-side">
                    <div className="member-block">
                      {taskDetail && taskDetail.members.length ? (
                        <div className="all-member pb-10">
                          {taskDetail.members.map((member, i) => {
                      ...
                      <div>
                        <AddMember
                          ...
                          selectMemberHandler={member =>
                            selectMemberHandler(member, taskDetail.id)
                          }
                        />
                      </div>
                    </div>
                    {taskDetail.labels && taskDetail.labels.length ? (
                      <div className="label-block">
                        <div className="heading">Labels</div>
                        <div className="all-labels">
                          {taskDetail.labels.map((e, i) => {
                            return (
                              <div
                                key={i}
                                title={e.name}
                    ...
                    {taskDetail && taskDetail.attachments.length ? (
                      <div className="task-attachment">
                        <div className="title">
                          Attachments ({taskDetail.attachments.length})
                        </div>
                        <div className="attachment-group">
                          {taskDetail.attachments.map((attachment, i) => {
                            return (
                              <TaskAttachments
                                key={i}
