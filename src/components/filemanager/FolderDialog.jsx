...
const FolderDialog = props => {
  ...
  return (
    ...
    >
      <ModalBody>
        <div className="fs-20 bold-text text-center ptb-10">Select Folder</div>
              ...
              orderedFolders.map(data => {
                return (
                  <tr
                    ...
                    key={data.id}
                    onClick={() => setSelectFolder(data.id)}
                  >
        ...
        <div className="text-right">
          <button
            ...
            onClick={() => moveFiletoFolderHandler(selectFolder)}
          >
            Move to folder
          </button>
        </div>
