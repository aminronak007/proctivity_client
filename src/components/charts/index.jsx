...
export const chartsObject = [
  ...
  },
  {
    title: "Doughnut",
    discription:
      "Doughnut charts are probably the most commonly used charts there are. They are divided into segments, the arc of each segment shows the proportional value of each piece of data.",
  ...
  },
  {
    title: "Pie",
    discription:
      "Pie charts are probably the most commonly used charts there are. They are divided into segments, the arc of each segment shows the proportional value of each piece of data.",
  ...
  },
  {
    title: "Polar",
    discription:
      "A Polar chart is a graph drawn with circular, polar coordinates. As shown in the example that follows, data points often fall within a certain distance of the middle of the circular graph and another axis.",
